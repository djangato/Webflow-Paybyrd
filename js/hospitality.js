    ...
    var biCards = [
      ...
      { title: "Peak-Time Demand Heatmap",
        ...
        svg: '<svg viewBox="0 0 260 110" fill="none">' +
          ...
          /* Animated heatmap cells — each row fades in with stagger */
          '<rect x="52" y="20" width="24" height="12" rx="2" fill="rgba(99,25,240,0.2)" opacity="0"><animate attributeName="opacity" values="0;1" dur="0.15s" begin="0.1s" fill="freeze"/></rect><rect x="80" y="20" width="24" height="12" rx="2" fill="rgba(99,25,240,0.15)" opacity="0"><animate attributeName="opacity" values="0;1" dur="0.15s" begin="0.15s" fill="freeze"/></rect><rect x="108" y="20" width="24" height="12" rx="2" fill="rgba(99,25,240,0.3)" opacity="0"><animate attributeName="opacity" values="0;1" dur="0.15s" begin="0.2s" fill="freeze"/></rect><rect x="136" y="20" width="24" height="12" rx="2" fill="rgba(99,25,240,0.4)" opacity="0"><animate attributeName="opacity" values="0;1" dur="0.15s" begin="0.25s" fill="freeze"/></rect><rect x="164" y="20" width="24" height="12" rx="2" fill="rgba(99,25,240,0.75)" opacity="0"><animate attributeName="opacity" values="0;1" dur="0.15s" begin="0.3s" fill="freeze"/></rect><rect x="192" y="20" width="24" height="12" rx="2" fill="rgba(99,25,240,0.95)" opacity="0"><animate attributeName="opacity" values="0;1" dur="0.15s" begin="0.35s" fill="freeze"/></rect><rect x="220" y="20" width="24" height="12" rx="2" fill="rgba(99,25,240,0.9)" opacity="0"><animate attributeName="opacity" values="0;1" dur="0.15s" begin="0.4s" fill="freeze"/></rect>' +
          '<rect x="52" y="36" width="24" height="12" rx="2" fill="rgba(99,25,240,0.35)" opacity="0"><animate attributeName="opacity" values="0;1" dur="0.15s" begin="0.2s" fill="freeze"/></rect><rect x="80" y="36" width="24" height="12" rx="2" fill="rgba(99,25,240,0.25)" opacity="0"><animate attributeName="opacity" values="0;1" dur="0.15s" begin="0.25s" fill="freeze"/></rect><rect x="108" y="36" width="24" height="12" rx="2" fill="rgba(99,25,240,0.3)" opacity="0"><animate attributeName="opacity" values="0;1" dur="0.15s" begin="0.3s" fill="freeze"/></rect><rect x="136" y="36" width="24" height="12" rx="2" fill="rgba(99,25,240,0.5)" opacity="0"><animate attributeName="opacity" values="0;1" dur="0.15s" begin="0.35s" fill="freeze"/></rect><rect x="164" y="36" width="24" height="12" rx="2" fill="rgba(99,25,240,0.65)" opacity="0"><animate attributeName="opacity" values="0;1" dur="0.15s" begin="0.4s" fill="freeze"/></rect><rect x="192" y="36" width="24" height="12" rx="2" fill="rgba(99,25,240,0.85)" opacity="0"><animate attributeName="opacity" values="0;1" dur="0.15s" begin="0.45s" fill="freeze"/></rect><rect x="220" y="36" width="24" height="12" rx="2" fill="rgba(99,25,240,0.6)" opacity="0"><animate attributeName="opacity" values="0;1" dur="0.15s" begin="0.5s" fill="freeze"/></rect>' +
          '<rect x="52" y="52" width="24" height="12" rx="2" fill="rgba(99,25,240,0.1)" opacity="0"><animate attributeName="opacity" values="0;1" dur="0.15s" begin="0.3s" fill="freeze"/></rect><rect x="80" y="52" width="24" height="12" rx="2" fill="rgba(99,25,240,0.1)" opacity="0"><animate attributeName="opacity" values="0;1" dur="0.15s" begin="0.35s" fill="freeze"/></rect><rect x="108" y="52" width="24" height="12" rx="2" fill="rgba(99,25,240,0.2)" opacity="0"><animate attributeName="opacity" values="0;1" dur="0.15s" begin="0.4s" fill="freeze"/></rect><rect x="136" y="52" width="24" height="12" rx="2" fill="rgba(99,25,240,0.45)" opacity="0"><animate attributeName="opacity" values="0;1" dur="0.15s" begin="0.45s" fill="freeze"/></rect><rect x="164" y="52" width="24" height="12" rx="2" fill="rgba(99,25,240,0.85)" opacity="0"><animate attributeName="opacity" values="0;1" dur="0.15s" begin="0.5s" fill="freeze"/></rect><rect x="192" y="52" width="24" height="12" rx="2" fill="rgba(99,25,240,1)" opacity="0"><animate attributeName="opacity" values="0;1" dur="0.15s" begin="0.55s" fill="freeze"/></rect><rect x="220" y="52" width="24" height="12" rx="2" fill="rgba(99,25,240,0.85)" opacity="0"><animate attributeName="opacity" values="0;1" dur="0.15s" begin="0.6s" fill="freeze"/></rect>' +
          '<rect x="52" y="68" width="24" height="12" rx="2" fill="rgba(99,25,240,0.4)" opacity="0"><animate attributeName="opacity" values="0;1" dur="0.15s" begin="0.4s" fill="freeze"/></rect><rect x="80" y="68" width="24" height="12" rx="2" fill="rgba(99,25,240,0.35)" opacity="0"><animate attributeName="opacity" values="0;1" dur="0.15s" begin="0.45s" fill="freeze"/></rect><rect x="108" y="68" width="24" height="12" rx="2" fill="rgba(99,25,240,0.3)" opacity="0"><animate attributeName="opacity" values="0;1" dur="0.15s" begin="0.5s" fill="freeze"/></rect><rect x="136" y="68" width="24" height="12" rx="2" fill="rgba(99,25,240,0.5)" opacity="0"><animate attributeName="opacity" values="0;1" dur="0.15s" begin="0.55s" fill="freeze"/></rect><rect x="164" y="68" width="24" height="12" rx="2" fill="rgba(99,25,240,0.75)" opacity="0"><animate attributeName="opacity" values="0;1" dur="0.15s" begin="0.6s" fill="freeze"/></rect><rect x="192" y="68" width="24" height="12" rx="2" fill="rgba(99,25,240,0.95)" opacity="0"><animate attributeName="opacity" values="0;1" dur="0.15s" begin="0.65s" fill="freeze"/></rect><rect x="220" y="68" width="24" height="12" rx="2" fill="rgba(99,25,240,0.8)" opacity="0"><animate attributeName="opacity" values="0;1" dur="0.15s" begin="0.7s" fill="freeze"/></rect>' +
          '<rect x="52" y="84" width="24" height="12" rx="2" fill="rgba(99,25,240,0.15)" opacity="0"><animate attributeName="opacity" values="0;1" dur="0.15s" begin="0.5s" fill="freeze"/></rect><rect x="80" y="84" width="24" height="12" rx="2" fill="rgba(99,25,240,0.1)" opacity="0"><animate attributeName="opacity" values="0;1" dur="0.15s" begin="0.55s" fill="freeze"/></rect><rect x="108" y="84" width="24" height="12" rx="2" fill="rgba(99,25,240,0.2)" opacity="0"><animate attributeName="opacity" values="0;1" dur="0.15s" begin="0.6s" fill="freeze"/></rect><rect x="136" y="84" width="24" height="12" rx="2" fill="rgba(99,25,240,0.25)" opacity="0"><animate attributeName="opacity" values="0;1" dur="0.15s" begin="0.65s" fill="freeze"/></rect><rect x="164" y="84" width="24" height="12" rx="2" fill="rgba(99,25,240,0.35)" opacity="0"><animate attributeName="opacity" values="0;1" dur="0.15s" begin="0.7s" fill="freeze"/></rect><rect x="192" y="84" width="24" height="12" rx="2" fill="rgba(99,25,240,0.5)" opacity="0"><animate attributeName="opacity" values="0;1" dur="0.15s" begin="0.75s" fill="freeze"/></rect><rect x="220" y="84" width="24" height="12" rx="2" fill="rgba(99,25,240,0.45)" opacity="0"><animate attributeName="opacity" values="0;1" dur="0.15s" begin="0.8s" fill="freeze"/></rect>' +
        '</svg>' },
